...
path_to_abstracts = "/Users/adriano/Desktop/ALTGRAD/lab1/data/Hulth2003testing/abstracts"
...
path_to_keywords = "/Users/adriano/Desktop/ALTGRAD/lab1/data/Hulth2003testing/uncontr"
...
for counter,g in enumerate(gs):
    ...
    max_w_c_n = max(w_core_numbers.values())
    keywords['wkc'].append([kwd for kwd, c_n in w_core_numbers.items() if c_n == max_w_c_n])
...
for counter,vector in enumerate(vectors_list):
    ...
    nonzero = [ter for ter in terms_weights if ter[1] > 0]
